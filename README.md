...
1. По можливості додайте знімок екрану ваших візуальних змін. Сторінка попереднього перегляду ваших змін запускається після того, як ваші зміни передаються на GitHub.
