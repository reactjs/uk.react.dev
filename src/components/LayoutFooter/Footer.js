      ...
      <div
        ...
        <div
          ...
          <FooterNav layoutHasSidebar={layoutHasSidebar}>
            <MetaTitle onDark={true}>Документація</MetaTitle>
          ...
          <FooterNav layoutHasSidebar={layoutHasSidebar}>
            <MetaTitle onDark={true}>Канали</MetaTitle>
            <ExternalFooterLink
          ...
          <FooterNav layoutHasSidebar={layoutHasSidebar}>
            <MetaTitle onDark={true}>Спільнота</MetaTitle>
          ...
          <FooterNav layoutHasSidebar={layoutHasSidebar}>
            <MetaTitle onDark={true}>Додатково</MetaTitle>
            <FooterLink to="/tutorial/tutorial.html">Введення</FooterLink>
