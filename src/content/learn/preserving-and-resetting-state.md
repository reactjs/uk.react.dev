...
<Diagram name="preserving_state_diff_same_pt1" height={350} width={794} alt="Діаграма з трьома секціями, розділеними стрілкою, що переходить між ними. Перша секція містить компонент React названий 'div' з єдиним дочірнім елементом названим 'section', який має єдиний дочірній елемент названий 'Counter', що містить бульбашковий стан названий 'count' із значенням 3. Центральна секція має той самий батьківський 'div' але дочірні компоненти тепер видалені, на що вказує жовте зображення 'пуф'. Третя секція має знову той самий батьківський 'div', тепер із новим дочірнім елементом названим 'div', що підсвічено жовтим, також із новим дочірнім елементом названим 'Counter' що містить бульбашковий стан названий 'count' із значенням 0, все підсвічено жовтим.">
