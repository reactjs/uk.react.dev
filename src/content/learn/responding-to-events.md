...
За домовленістю обробники подій прийнято називати, починаючи з `handle`, за яким слідує назва події. Ви часто побачите щось на кшталт `onClick={handleClick}`, `onMouseEnter={handleMouseEnter}` тощо.
