...
Ускладнення користувальницького інтерфейсу не повинно погіршувати доступність контенту. Незважаючи на те, що кращий результат досягається при максимальному використанні синтаксису HTML, навіть дуже складний компонент можна зробити доступним для всіх.
...
Наведені вище посилання є набором інструкцій по HTML-атрибутам, які повністю підтримуються в JSX. Використовуючи їх можна створювати високо-функціональні і при цьому повністю доступні React-компоненти.
