...
### Дочірні JSX-компоненти {#jsx-children}
...
JavaScript-вирази можуть використовуватися разом з іншими типами дочірніх компонентів. Їх також буває корисно використовувати замість шаблонних рядків:
