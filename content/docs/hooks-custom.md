...
## Використання користувацьких хуків {#using-a-custom-hook}
...
Потреба керувати локальним станом складного компонента за допомогою редюсера доволі поширена. Саме тому ми додали хук `useReducer` до React. Ви знайдете його разом з іншими вбудованими хуками у [API-довіднику хуків](/docs/hooks-reference.html).
