...
Ви побачите, що ми маємо п'ять компонентів у нашому додатку. Дані, які представляє кожен компонент, виділено курсивом. The numbers in the image correspond to the numbers below.
