...
Наприклад, якщо ми переходимо з одної сторінки на іншу, і код або дані для наступного екрану досі не завантажились, дивитися спершу на пусту сторінку з індикатором завантаження може бути неприємно. Ми б радше хотіли затриматися на попередньому екрані. Історично, ввести такий патерн в React було складно. Паралельний режим пропонує новий набір інструментів для таких цілей.
...
В результаті, натискання "Next" не виконує негайний перехід в "небажаний" стан завантаження, а спершу залишається на попередньому екрані і там же повідомляє про прогресс.
