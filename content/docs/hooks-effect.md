...
>
>Якщо ви хочете запустити ефект і скинути його тільки один раз (при монтуванні і розмонтуванні), ви можете передати порожній масив (`[]`) другим аргументом. React вважатиме, що ваш ефект не залежить від *будь-яких* значень з пропсів або стану і тому не буде виконувати повторних рендерів. Це не обробляється як особливий випадок -- він безпосередньо випливає з логіки роботи масивів залежностей.
>
...
Вітаємо! Це була довга сторінка, але ми сподіваємося, що під кінець, у нас вийшло відповісти на всі ваші запитання з приводу роботи ефектів. Ви вже дізналися про хук стану і про хук ефекту, і тепер є *дуже багато* речей, які ви можете робити, об'єднавши їх разом. Вони охоплюють більшість випадків для використання класів. В інших випадках, вам можуть стати в нагоді [додаткові хуки](/docs/hooks-reference.html).
