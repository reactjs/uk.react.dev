...
| Знахідний | рендер | _рендерів_ |
| Давальний | _рендеру_ | _рендерам_ |
| Родовий | _рендера_ | _рендерів_ |
...
| Давальний | _пропсу_ | _пропсам_ |
| Родовий | _проса_ | _пропсів_ |
| Місцевий | _пропсі_ | _пропсах_ |
| Орудний | _пропсом_ | _пропсами_ |
